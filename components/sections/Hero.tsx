  ...
  return (
    <SectionWrapper id="hero" className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        <div className="flex flex-col items-start z-10">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              ...
              className="px-7 py-3.5 rounded-full bg-white text-black font-semibold text-sm hover:bg-gray-200 transition-all duration-300 flex items-center gap-2 group shadow-[0_0_20px_rgba(255,255,255,0.25)] hover:shadow-[0_0_25px_rgba(0,255,255,0.4)]"
            >
              Ver projetos
            ...
            <a
              ...
              className="px-7 py-3.5 rounded-full bg-[#1a1a1a] text-white font-medium text-sm border border-gray-700 hover:border-[#00FFFF] hover:text-[#00FFFF] transition-all duration-300 shadow-md"
            >
              Entrar em contato
            </a>
          </div>
        ...
        {/* Right Column - Orbital Skill Carousel */}
